...
Report incidents to the maintainer via GitHub Issues (private security reports:
see [SECURITY.md](https://github.com/Selvaganapathiarumugam/tamilPY/blob/Production/SECURITY.md)) or the contact listed on the author's portfolio.
